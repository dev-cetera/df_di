...
//   final Type type;
//   _ReservedSafeFinisher(this.type);
...
//   //   final b = (_ReservedSafeFinisher).hashCode;
...
//     final temp = _ReservedSafeFinisher(type);
//     register<_ReservedSafeFinisher>(temp, groupEntity: g);
//     return temp.resolvable().map((e) {
//       registry.removeDependency<_ReservedSafeFinisher>(groupEntity: g);
//       return e;
//     });
//   }
